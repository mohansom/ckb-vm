...
static const unsigned char bf_actions[1549] = {
  ...
  208,65,89,65,88,90,89,88,94,95,195,248,11,72,193,225,235,72,141,183,233,72,
  1,206,72,199,193,237,248,1,72,131,252,249,0,15,132,244,248,87,86,81,72,184,
  237,237,72,141,191,233,252,255,208,89,94,95,136,6,72,131,252,233,1,72,131,
  198,1,252,233,244,1,248,2,255,65,89,65,88,90,89,88,94,95,195,248,12,87,86,
  80,81,82,65,80,65,81,72,141,151,233,138,18,128,252,250,0,15,133,244,247,252,
  233,244,10,248,1,252,233,244,11,255,248,13,86,65,80,72,137,214,72,137,193,
  72,193,252,233,235,255,72,129,252,249,239,15,131,244,249,72,141,151,233,15,
  182,20,10,129,226,239,129,252,250,239,15,133,244,250,255,72,193,252,233,235,
  72,141,151,233,68,15,182,4,10,65,131,252,248,0,15,133,244,247,198,4,10,1,
  232,244,12,248,1,255,72,137,194,72,1,252,242,72,131,252,234,1,72,193,252,
  234,235,72,131,193,1,72,57,209,15,133,244,248,255,72,129,252,249,239,15,131,
  244,249,72,141,151,233,15,182,20,10,129,226,239,129,252,250,239,15,133,244,
  250,72,193,252,233,235,72,141,151,233,68,15,182,4,10,65,131,252,248,0,15,
  133,244,248,198,4,10,1,232,244,12,248,2,72,199,194,0,0,0,0,65,88,94,195,248,
  3,72,199,194,237,65,88,94,195,248,4,72,199,194,237,255,65,88,94,195,255,248,
  14,86,65,80,72,137,193,72,193,252,233,235,72,129,252,249,239,15,131,244,249,
  ...
  76,137,135,233,76,137,143,233,93,91,65,95,65,94,65,93,65,92,195,255,249,255,
  ...
  32,72,129,202,239,255,72,15,175,194,255,72,133,192,15,148,208,72,15,182,192,
  255,72,1,200,252,233,244,248,255,72,137,208,248,2,255,72,184,237,237,255,
...
#line 403 "src/machine/aot/aot.x64.c"
  ...
  //|1:
  //| jmp ->random_memory
  dasm_put(Dst, 137, Dt1(->chaos_mode));
...
#line 434 "src/machine/aot/aot.x64.c"
  ...
  //| jne >4
  dasm_put(Dst, 200, CKB_VM_ASM_RISCV_PAGES, Dt1(->flags), CKB_VM_ASM_MEMORY_FLAG_WXORX_BIT, CKB_VM_ASM_MEMORY_FLAG_WRITABLE);
#line 445 "src/machine/aot/aot.x64.c"
  ...
  //| call ->inited_memory
  //|1:
  dasm_put(Dst, 229, CKB_VM_ASM_MEMORY_FRAME_PAGE_SHIFTS, Dt1(->frames));
#line 456 "src/machine/aot/aot.x64.c"
  ...
  //| cmp rcx, rdx
  //| jne >2
  dasm_put(Dst, 262, CKB_VM_ASM_RISCV_PAGE_SHIFTS);
#line 464 "src/machine/aot/aot.x64.c"
  ...
  //| pop r8
  dasm_put(Dst, 291, CKB_VM_ASM_RISCV_PAGES, Dt1(->flags), CKB_VM_ASM_MEMORY_FLAG_WXORX_BIT, CKB_VM_ASM_MEMORY_FLAG_WRITABLE, CKB_VM_ASM_MEMORY_FRAME_PAGE_SHIFTS, Dt1(->frames), CKB_VM_ASM_RET_OUT_OF_BOUND, CKB_VM_ASM_RET_INVALID_PERMISSION);
...
#line 497 "src/machine/aot/aot.x64.c"
  ...
  //| call ->inited_memory
  //| jmp >2
  dasm_put(Dst, 384, CKB_VM_ASM_MEMORY_FRAME_SHIFTS, CKB_VM_ASM_MEMORY_FRAMES, Dt1(->frames), CKB_VM_ASM_MEMORY_FRAME_SHIFTS, CKB_VM_ASM_MEMORY_FRAMES);
#line 529 "src/machine/aot/aot.x64.c"
  ...
  //| pop rsi
  //| ret
  dasm_put(Dst, 480, CKB_VM_ASM_RET_OUT_OF_BOUND);
#line 539 "src/machine/aot/aot.x64.c"
  ...
  //| pop r12
  //| ret
  dasm_put(Dst, 508, Dt1(->registers[REGISTER_RA]), Dt1(->registers[REGISTER_SP]), Dt1(->registers[REGISTER_A0]));
...
int aot_add(AotContext* context, riscv_register_t target, AotValue a, AotValue b)
{
  ...
  switch (b.tag) {
    case AOT_TAG_REGISTER:
      ...
      if (VALID_X64_REGISTER(loc1) && VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 536, (loc2), (loc1));
      } else if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 544, (loc1), Dt1(->registers[b.value.reg]));
      } else if (VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 552, (loc2), Dt1(->registers[target]));
      } else {
      dasm_put(Dst, 560, Dt1(->registers[b.value.reg]), Dt1(->registers[target]));
      }
#line 618 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_IMMEDIATE:
      ...
      if (b.value.i > 0xFFFFFFFF && ((b.value.i & 0xFFFFFFFF80000000) != 0xFFFFFFFF80000000)) {
        loc1 = riscv_reg_to_x64_reg(target);
      dasm_put(Dst, 569, b.value.i >> 32, b.value.i & 0xFFFFFFFF);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 582, (loc1));
        } else {
      dasm_put(Dst, 564, Dt1(->registers[target]));
        }
      } else {
        loc1 = riscv_reg_to_x64_reg(target);
        if (VALID_X64_REGISTER(loc1)) {
...
#line 621 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      loc1 = riscv_reg_to_x64_reg(target);
      if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 536, (b.value.x64_reg), (loc1));
      } else {
      dasm_put(Dst, 552, (b.value.x64_reg), Dt1(->registers[target]));
      }
...
int aot_sub(AotContext* context, riscv_register_t target, AotValue a, AotValue b)
{
  ...
  switch (b.tag) {
    case AOT_TAG_REGISTER:
      ...
      loc2 = riscv_reg_to_x64_reg(b.value.reg);
      if (VALID_X64_REGISTER(loc1) && VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 601, (loc2), (loc1));
      } else if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 609, (loc1), Dt1(->registers[b.value.reg]));
      } else if (VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 617, (loc2), Dt1(->registers[target]));
      } else {
      dasm_put(Dst, 625, Dt1(->registers[b.value.reg]), Dt1(->registers[target]));
      }
#line 649 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_IMMEDIATE:
      ...
      dasm_put(Dst, 569, b.value.i >> 32, b.value.i & 0xFFFFFFFF);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 634, (loc1));
        } else {
      dasm_put(Dst, 629, Dt1(->registers[target]));
        }
      } else {
        loc1 = riscv_reg_to_x64_reg(target);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 640, (loc1), b.value.i);
        } else {
      dasm_put(Dst, 647, Dt1(->registers[target]), b.value.i);
        }
      }
#line 652 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      loc1 = riscv_reg_to_x64_reg(target);
      if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 601, (b.value.x64_reg), (loc1));
      } else {
      dasm_put(Dst, 617, (b.value.x64_reg), Dt1(->registers[target]));
      }
...
int aot_mul(AotContext* context, riscv_register_t target, AotValue a, AotValue b)
{
  ...
  switch (b.tag) {
    case AOT_TAG_REGISTER:
      ...
      dasm_put(Dst, 660, Dt1(->registers[b.value.reg]));
      }
#line 673 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_IMMEDIATE:
      ...
      if (b.value.i > 0xFFFFFFFF && ((b.value.i & 0xFFFFFFFF80000000) != 0xFFFFFFFF80000000)) {
      dasm_put(Dst, 666, b.value.i >> 32, b.value.i & 0xFFFFFFFF);
      } else {
      dasm_put(Dst, 679, b.value.i);
      }
...
#line 677 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      dasm_put(Dst, 653, (b.value.x64_reg));
#line 680 "src/machine/aot/aot.x64.c"
  ...
  loc1 = riscv_reg_to_x64_reg(target);
  if (VALID_X64_REGISTER(loc1)) {
  dasm_put(Dst, 689, (loc1));
  } else {
  dasm_put(Dst, 695, Dt1(->registers[target]));
  }
...
#line 716 "src/machine/aot/aot.x64.c"
        ...
        dasm_put(Dst, 713, (b.value.x64_reg));
#line 718 "src/machine/aot/aot.x64.c"
  ...
  dasm_put(Dst, 743, Dt1(->registers[target]));
  }
...
#line 764 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_IMMEDIATE:
      ...
      if (b.value.i > 0xFFFFFFFF && ((b.value.i & 0xFFFFFFFF80000000) != 0xFFFFFFFF80000000)) {
      dasm_put(Dst, 771, b.value.i >> 32, b.value.i & 0xFFFFFFFF);
      } else {
      dasm_put(Dst, 374, b.value.i);
      }
...
int aot_div(AotContext* context, riscv_register_t target, AotValue a, AotValue b, int is_signed)
{
  ...
  if (is_signed) {
    //| mov64 rax, INT64_MIN
    dasm_put(Dst, 814, (unsigned int)(INT64_MIN), (unsigned int)((INT64_MIN)>>32));
...
#line 823 "src/machine/aot/aot.x64.c"
  ...
  if ((uint64_t)UINT64_MAX > 0xFFFFFFFF && (((uint64_t)UINT64_MAX & 0xFFFFFFFF80000000) != 0xFFFFFFFF80000000)) {
    loc1 = riscv_reg_to_x64_reg(target);
  dasm_put(Dst, 569, (uint64_t)UINT64_MAX >> 32, (uint64_t)UINT64_MAX & 0xFFFFFFFF);
    if (VALID_X64_REGISTER(loc1)) {
  dasm_put(Dst, 689, (loc1));
    } else {
  dasm_put(Dst, 695, Dt1(->registers[target]));
    ...
    loc1 = riscv_reg_to_x64_reg(target);
    if (VALID_X64_REGISTER(loc1)) {
  dasm_put(Dst, 869, (loc1), (uint64_t)UINT64_MAX);
    } else {
  dasm_put(Dst, 876, Dt1(->registers[target]), (uint64_t)UINT64_MAX);
    }
  }
  ...
  switch (b.tag) {
    case AOT_TAG_REGISTER:
      if (is_signed) {
        ...
        dasm_put(Dst, 900, Dt1(->registers[b.value.reg]));
        }
#line 837 "src/machine/aot/aot.x64.c"
        ...
        dasm_put(Dst, 918, Dt1(->registers[b.value.reg]));
        }
...
#line 850 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      if (is_signed) {
        ...
        dasm_put(Dst, 941, (b.value.x64_reg));
...
#line 881 "src/machine/aot/aot.x64.c"
    ...
    if ((uint64_t)0 > 0xFFFFFFFF && (((uint64_t)0 & 0xFFFFFFFF80000000) != 0xFFFFFFFF80000000)) {
      loc1 = riscv_reg_to_x64_reg(target);
    dasm_put(Dst, 569, (uint64_t)0 >> 32, (uint64_t)0 & 0xFFFFFFFF);
      if (VALID_X64_REGISTER(loc1)) {
    dasm_put(Dst, 689, (loc1));
      } else {
    dasm_put(Dst, 695, Dt1(->registers[target]));
      ...
      loc1 = riscv_reg_to_x64_reg(target);
      if (VALID_X64_REGISTER(loc1)) {
    dasm_put(Dst, 869, (loc1), (uint64_t)0);
      } else {
    dasm_put(Dst, 876, Dt1(->registers[target]), (uint64_t)0);
      }
    }
...
int aot_and(AotContext* context, riscv_register_t target, AotValue a, AotValue b)
{
  ...
  switch (b.tag) {
    case AOT_TAG_REGISTER:
      ...
      loc2 = riscv_reg_to_x64_reg(b.value.reg);
      if (VALID_X64_REGISTER(loc1) && VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 965, (loc2), (loc1));
      } else if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 973, (loc1), Dt1(->registers[b.value.reg]));
      } else if (VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 981, (loc2), Dt1(->registers[target]));
      } else {
      dasm_put(Dst, 989, Dt1(->registers[b.value.reg]), Dt1(->registers[target]));
      }
#line 955 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_IMMEDIATE:
      ...
      dasm_put(Dst, 569, b.value.i >> 32, b.value.i & 0xFFFFFFFF);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 998, (loc1));
        } else {
      dasm_put(Dst, 993, Dt1(->registers[target]));
        }
      } else {
        loc1 = riscv_reg_to_x64_reg(target);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1004, (loc1), b.value.i);
        } else {
      dasm_put(Dst, 1011, Dt1(->registers[target]), b.value.i);
        }
      }
#line 958 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      loc1 = riscv_reg_to_x64_reg(target);
      if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 965, (b.value.x64_reg), (loc1));
      } else {
      dasm_put(Dst, 981, (b.value.x64_reg), Dt1(->registers[target]));
      }
...
int aot_or(AotContext* context, riscv_register_t target, AotValue a, AotValue b)
{
  ...
  switch (b.tag) {
    case AOT_TAG_REGISTER:
      ...
      loc2 = riscv_reg_to_x64_reg(b.value.reg);
      if (VALID_X64_REGISTER(loc1) && VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 1017, (loc2), (loc1));
      } else if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1025, (loc1), Dt1(->registers[b.value.reg]));
      } else if (VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 1033, (loc2), Dt1(->registers[target]));
      } else {
      dasm_put(Dst, 1041, Dt1(->registers[b.value.reg]), Dt1(->registers[target]));
      }
#line 986 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_IMMEDIATE:
      ...
      dasm_put(Dst, 1045, Dt1(->registers[target]));
        ...
        loc1 = riscv_reg_to_x64_reg(target);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1056, (loc1), b.value.i);
        } else {
      dasm_put(Dst, 1063, Dt1(->registers[target]), b.value.i);
        }
      }
#line 989 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      loc1 = riscv_reg_to_x64_reg(target);
      if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1017, (b.value.x64_reg), (loc1));
      } else {
      dasm_put(Dst, 1033, (b.value.x64_reg), Dt1(->registers[target]));
      }
...
#line 1008 "src/machine/aot/aot.x64.c"
  if (logical) {
    ...
    if ((uint64_t)1 > 0xFFFFFFFF && (((uint64_t)1 & 0xFFFFFFFF80000000) != 0xFFFFFFFF80000000)) {
      loc1 = riscv_reg_to_x64_reg(target);
    dasm_put(Dst, 569, (uint64_t)1 >> 32, (uint64_t)1 & 0xFFFFFFFF);
      if (VALID_X64_REGISTER(loc1)) {
    dasm_put(Dst, 998, (loc1));
      } else {
    dasm_put(Dst, 993, Dt1(->registers[target]));
      ...
      loc1 = riscv_reg_to_x64_reg(target);
      if (VALID_X64_REGISTER(loc1)) {
    dasm_put(Dst, 1004, (loc1), (uint64_t)1);
      } else {
    dasm_put(Dst, 1011, Dt1(->registers[target]), (uint64_t)1);
      }
    }
...
int aot_xor(AotContext* context, riscv_register_t target, AotValue a, AotValue b)
{
  ...
  switch (b.tag) {
    case AOT_TAG_REGISTER:
      ...
      loc2 = riscv_reg_to_x64_reg(b.value.reg);
      if (VALID_X64_REGISTER(loc1) && VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 1082, (loc2), (loc1));
      } else if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1090, (loc1), Dt1(->registers[b.value.reg]));
      } else if (VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 1098, (loc2), Dt1(->registers[target]));
      } else {
      dasm_put(Dst, 1106, Dt1(->registers[b.value.reg]), Dt1(->registers[target]));
      }
#line 1034 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_IMMEDIATE:
      ...
      dasm_put(Dst, 569, b.value.i >> 32, b.value.i & 0xFFFFFFFF);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1115, (loc1));
        } else {
      dasm_put(Dst, 1110, Dt1(->registers[target]));
        }
      } else {
        loc1 = riscv_reg_to_x64_reg(target);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1121, (loc1), b.value.i);
        } else {
      dasm_put(Dst, 1129, Dt1(->registers[target]), b.value.i);
        }
      }
#line 1037 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      loc1 = riscv_reg_to_x64_reg(target);
      if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1082, (b.value.x64_reg), (loc1));
      } else {
      dasm_put(Dst, 1098, (b.value.x64_reg), Dt1(->registers[target]));
      }
...
int aot_shl(AotContext* context, riscv_register_t target, AotValue a, AotValue b)
{
  ...
  switch (b.tag) {
    case AOT_TAG_REGISTER:
      ...
      dasm_put(Dst, 1141, Dt1(->registers[b.value.reg]));
      }
...
#line 1098 "src/machine/aot/aot.x64.c"
  ...
  if (is_signed) {
    ...
    dasm_put(Dst, 1167, Dt1(->registers[target]));
    }
...
int aot_eq(AotContext* context, riscv_register_t target, AotValue a, AotValue b)
{
  ...
  switch (b.tag) {
    case AOT_TAG_REGISTER:
      ...
      dasm_put(Dst, 1189, Dt1(->registers[b.value.reg]));
      }
...
#line 1126 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      dasm_put(Dst, 1183, (b.value.x64_reg));
#line 1129 "src/machine/aot/aot.x64.c"
  ...
  loc1 = riscv_reg_to_x64_reg(target);
  if (VALID_X64_REGISTER(loc1)) {
  dasm_put(Dst, 1211, (loc1));
  } else {
  dasm_put(Dst, 1217, Dt1(->registers[target]));
  }
...
int aot_cond(AotContext* context, riscv_register_t target, AotValue condition, AotValue true_value, AotValue false_value) {
  ...
  switch (condition.tag) {
    case AOT_TAG_REGISTER:
      ...
      dasm_put(Dst, 569, (uint64_t)1 >> 32, (uint64_t)1 & 0xFFFFFFFF);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1230, (loc1));
        } else {
      dasm_put(Dst, 1236, Dt1(->registers[condition.value.reg]));
        }
      } else {
        loc1 = riscv_reg_to_x64_reg(condition.value.reg);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1241, (loc1), (uint64_t)1);
        } else {
      dasm_put(Dst, 1249, Dt1(->registers[condition.value.reg]), (uint64_t)1);
        }
      }
...
#line 1188 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      //| jne >1
      dasm_put(Dst, 1262, (condition.value.x64_reg));
...
#line 1250 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_IMMEDIATE:
      if (bits.value.i < 64) {
        ...
        dasm_put(Dst, 1306, (64 - bits.value.i));
#line 1255 "src/machine/aot/aot.x64.c"
        if (is_signed) {
          //| sar rax, (64 - bits.value.i)
          dasm_put(Dst, 1311, (64 - bits.value.i));
...
#line 1259 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      //| shl rax, cl
      //| mov ecx, edx
      dasm_put(Dst, 1322, (bits.value.x64_reg));
...
int aot_add_cycles(AotContext* context, uint64_t cycles)
{
  ...
  dasm_put(Dst, 569, cycles >> 32, cycles & 0xFFFFFFFF);
  } else {
  dasm_put(Dst, 1194, cycles);
  }
#line 1298 "src/machine/aot/aot.x64.c"
  ...
  //| jna >1
  dasm_put(Dst, 1352, Dt1(->cycles), Dt1(->max_cycles), Dt1(->cycles));
    ...
    case AOT_TAG_IMMEDIATE:
      ...
      switch ((uint8_t) (value.value.i >> 56)) {
        case 0x80:
          ...
          dasm_put(Dst, 666, (value.value.i & 0xFFFFFFFFFFFFFF) >> 32, (value.value.i & 0xFFFFFFFFFFFFFF) & 0xFFFFFFFF);
          } else {
          dasm_put(Dst, 679, (value.value.i & 0xFFFFFFFFFFFFFF));
          }
...
#line 1354 "src/machine/aot/aot.x64.c"
        ...
        case 0x40:
          ...
          dasm_put(Dst, 1369, Dt1(->pc), ((uint32_t)(value.value.i & 0x7FFFFFFF)), ((value.value.i >> 32) ^ 0x40000000));
#line 1358 "src/machine/aot/aot.x64.c"
        ...
        case 0x0:
          ...
          dasm_put(Dst, 666, value.value.i >> 32, value.value.i & 0xFFFFFFFF);
          } else {
          dasm_put(Dst, 679, value.value.i);
          }
...
#line 1362 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      dasm_put(Dst, 1378, (value.value.x64_reg), Dt1(->pc));
...
int aot_memory_write(AotContext* context, AotValue address, AotValue v, uint32_t size)
{
  ...
  dasm_put(Dst, 1386, size, Dt1(->memory));
...
int aot_memory_read(AotContext* context, uint32_t target, AotValue address, uint32_t size)
{
  ...
  dasm_put(Dst, 1437, size, size, CKB_VM_ASM_RISCV_MAX_MEMORY);
...
static int aot_mov_internal(AotContext* context, riscv_register_t target, AotValue value, x64_register_t x64_temp_reg)
{
  ...
  switch (value.tag) {
    case AOT_TAG_REGISTER:
      ...
      if (VALID_X64_REGISTER(loc1) && VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 1499, (loc2), (loc1));
      } else if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1507, (loc1), Dt1(->registers[value.value.reg]));
      } else if (VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 1378, (loc2), Dt1(->registers[target]));
      } else {
      dasm_put(Dst, 1515, (x64_temp_reg), Dt1(->registers[value.value.reg]), (x64_temp_reg), Dt1(->registers[target]));
      }
#line 1511 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_IMMEDIATE:
      ...
      if (value.value.i > 0xFFFFFFFF && ((value.value.i & 0xFFFFFFFF80000000) != 0xFFFFFFFF80000000)) {
        loc1 = riscv_reg_to_x64_reg(target);
      dasm_put(Dst, 1530, (x64_temp_reg), value.value.i >> 32, (x64_temp_reg), (x64_temp_reg), value.value.i & 0xFFFFFFFF);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1499, (x64_temp_reg), (loc1));
        } else {
      dasm_put(Dst, 1378, (x64_temp_reg), Dt1(->registers[target]));
        }
      } else {
        loc1 = riscv_reg_to_x64_reg(target);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 869, (loc1), value.value.i);
        } else {
      dasm_put(Dst, 876, Dt1(->registers[target]), value.value.i);
        }
      }
#line 1514 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      loc1 = riscv_reg_to_x64_reg(target);
      if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1499, (value.value.x64_reg), (loc1));
      } else {
      dasm_put(Dst, 1378, (value.value.x64_reg), Dt1(->registers[target]));
      }
...
static int aot_mov_x64(AotContext* context, x64_register_t x64_target, AotValue value)
{
  ...
  switch (value.tag) {
    case AOT_TAG_REGISTER:
      ...
      if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1499, (loc1), (x64_target));
      } else {
      dasm_put(Dst, 1507, (x64_target), Dt1(->registers[value.value.reg]));
      }
#line 1530 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_IMMEDIATE:
      ...
      if (value.value.i > 0xFFFFFFFF && ((value.value.i & 0xFFFFFFFF80000000) != 0xFFFFFFFF80000000)) {
      dasm_put(Dst, 1530, (x64_target), value.value.i >> 32, (x64_target), (x64_target), value.value.i & 0xFFFFFFFF);
      } else {
      dasm_put(Dst, 869, (x64_target), value.value.i);
      }
#line 1533 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      dasm_put(Dst, 1499, (value.value.x64_reg), (x64_target));
