...
pub use crate::{
    ...
    machine::{
        pprof::PProfMachine, trace::TraceMachine, CoreMachine, DefaultCoreMachine, DefaultMachine,
...
pub use ckb_vm_definitions::{
    registers, DEFAULT_STACK_SIZE, ISA_B, ISA_IMAC, ISA_MOP, MEMORY_FRAMES, MEMORY_FRAMESIZE,
